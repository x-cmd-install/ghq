...
[![x-cmd/install — ghq Code Quality Monitoring Repo Card](https://repo.x-cmd.io/ghq.svg?lang=zh)](https://x-cmd.com/install/ghq)
...
- **上游仓库**: <https://github.com/x-motemen/ghq>
- **许可证**: MIT
...
- **Star**: 3,774 · **Fork**: 210 · **开放 issue**: 137 · **贡献者**: 89
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ghq.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T05:05:09Z._
